...
function changeName(array, index, newName) {
  array[index].name = newName; // working
  console.log(array);
}
...
function getArtistByIndex(array, index) {
  return ` The artist at index ${index} is ${array[index].name}`; // working
}
...
//     if (
//       array[i].years.substr(0, 1) == "19" &&
//       array[i].years.substr(7, 8) == "19"
//     ) {
//       decade.push(array[i].name);
//     }
//   }
//   return decade;
// }
